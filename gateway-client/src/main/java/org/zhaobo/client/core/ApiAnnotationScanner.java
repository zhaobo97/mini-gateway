...
public class ApiAnnotationScanner {
    ...
    public ServiceDefinition scanner(Object bean, Object... args) {
        ...
        HashMap<String/*path*/, ServiceInvoker> invokerMap = new HashMap<>();
            ...
            for (Method method : methods) {
                ...
                switch (protocol){
                    ...
                    case DUBBO:
                        ...
                        if (StringUtils.isNotBlank(dubboServiceInvoker.getVersion())){
                            version = dubboServiceInvoker.getVersion();
                        }
